class LabsController < ApplicationController
  ...
  def create
    ...
    @users=User.where(:id => params[:users_selection])
  ...
  def update
    ...
    @users=User.where(:id => params[:users_selection])
    @lab.users.destroy_all   #disassociate the already added organizers
    @lab.users << @users
    respond_to do |format|
  ...
  private
    ...
    def lab_params
      params.require(:lab).permit(:name, :password, :password_confirmation, :mingroup, :maxgroup)
    end
end
