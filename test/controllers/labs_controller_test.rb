...
class LabsControllerTest < ActionController::TestCase
  ...
  test "should create lab" do
    assert_difference('Lab.count') do
      post :create, lab: { maxgroup: @lab.maxgroup, mingroup: @lab.mingroup, name: @lab.name, password: 'secret', password_confirmation: 'secret' }
    end
  ...
  test "should update lab" do
    patch :update, id: @lab, lab: { maxgroup: @lab.maxgroup, mingroup: @lab.mingroup, name: @lab.name, password: 'secret', password_confirmation: 'secret' }
    assert_redirected_to lab_path(assigns(:lab))
  end
